...
public class TransferHandler {
    ...
    private void displayTime(long pastTime, long nowTime, long bytesRecieveAll, long bytesReadNow, double totalTime) {
        ...
        System.out.printf("Текущая скорость (байт/сек) %.2f, (MB/s) %.2f\n", instantSpeed, instantSpeed/ (1024 * 1024));
        System.out.printf("Средняя скорость (байт/сек) %.2f, (MB/s) %.2f\n", avaregeTime, avaregeTime/ (1024 * 1024));
